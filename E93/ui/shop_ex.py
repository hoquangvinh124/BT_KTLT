from E93.TestXML.XMLTest import *
from PyQt6.QtWidgets import QPushButton, QVBoxLayout, QWidget
from E93.ui.shop import Ui_MainWindow
...
class MainWindowEx(QWidget, Ui_MainWindow):
    ...
    def create_button(self, product_list):
        self.clear_layout(self.verticalLayoutButton)
        for product in product_list:
            btn = QPushButton(product.__str__())
            pil_image = Image.open(product.file_path).convert("RGBA")
            q_image = QImage(
                pil_image.tobytes(),
                pil_image.width,
                pil_image.height,
            ...
            btn.setStyleSheet("text-align: left; padding-left: 60px;")
