# Form implementation generated from reading ui file 'D:\TDT!!!\112\ProductManagement.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(456, 469)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("D:\\TDT!!!\\112\\images/ic_logo.jpg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        MainWindow.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(parent=MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(parent=self.centralwidget)
        self.label.setGeometry(QtCore.QRect(50, 0, 371, 41))
        font = QtGui.QFont()
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 370, 431, 61))
        self.groupBox.setStyleSheet("background-color: rgb(251, 255, 206);")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("D:\\TDT!!!\\112\\images/ic_delete.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("D:\\TDT!!!\\112\\images/ic_save.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("D:\\TDT!!!\\112\\images/ic_new.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 250, 431, 111))
        self.groupBox_2.setStyleSheet("background-color: rgb(251, 255, 206);")
        ...
        self.lineEditUnitPrice.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.lineEditProductId.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.lineEditProductId.setText("")
        self.lineEditProductId.setObjectName("lineEditProductId")
        self.groupBox_3 = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 40, 431, 201))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "ProductManagement"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; color:#aa00ff;\">Product Management</span></p></body></html>"))
        ...
        self.label_2.setText(_translate("MainWindow", "Product Code:"))
